 ...
 * @brief Whill RT-component
 *
 * RT-Component for Whill (wheel chair)
 *
 * In: Target Velocity (unit: m/s, rad/s),
 * Out: Current Pose  Estimated (unit: m, rad)
 *
 * https://github.com/WHILL/libwhill/
 *
 */
class WhillTest
...
extern "C"
{
  DLL_EXPORT void WhillTestInit(RTC::Manager* manager);
};
